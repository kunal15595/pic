...
***************************************************************************************************
[File]          : Config_UART.c
[Processor]     : PIC24F Macros used for initialization and Data transfer etc.
[Compiler]      : MPLAB C30
[Description]   : UART1 and UART2 Initialization.        
--------------------------------------------------------------------------------------------------- 	
...
[DESCRIPTION]    : This function initializes the UART1 with desired Baud rate and other default settings
...
[RETURN]	 : Task execution status success or failure
[DESCRIPTION]    : This function initializes the UART1 with desired Baud rate and other default settings
                   8BIT - NO PARITY - 1 STOP BIT. The Baud rate mode is High Baud rate.
--------------------------------------------------------------------------------------------------- 
*/
