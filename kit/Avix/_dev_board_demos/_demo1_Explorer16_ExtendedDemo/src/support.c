...
//	Description:
//  ------------
//	This file contains demo application support functionality.
//	===============================================================================================
//	INCLUDES:
//	===============================================================================================
//
...
//	==============================
//	Conver an unsigned short to a string of four characters, optionally replace leading ascii zeros
//	with blanks.
//	===============================================================================================
//
int convertIntToString(unsigned short v, char* pBuffer, int convertLeadZeros)
{
	int 	i;
	char* 	p;
	int		maxChars;
