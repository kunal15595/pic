#ifndef __CONTROLEXCHANGE_h__
#define __CONTROLEXCHANGE_h__
...
//	-----------------------------------------------------------------------------------------------
//	FILENAME			controlExchange.h
//	-----------------------------------------------------------------------------------------------
//	This file contains the definitions of the control Exchange kernel object as required by users
...
//	===============================================================================================
//
typedef struct tAppControl
{
	unsigned short input1Active;
	unsigned short input2Active;
...
//	===============================================================================================
//
#define APP_CONTROL_SAMPLE_PERIOD_MIN	2
#define APP_CONTROL_SAMPLE_PERIOD_MAX	10
...
//	===============================================================================================
//
extern tavixExchId controlExchCreateAndInit(void);
extern void 	   controlExchUpdateSamplePeriod(tavixExchId exchId, int up);
extern void 	   controlExchUpdateChannels	(tavixExchId exchId);
