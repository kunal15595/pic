...
/**
  ...
  @Example 
    Refer to the example of DRV_TMR1_Initialize();
*/
...
/**
  ...
  @Example 
    ...
    DRV_TMR1_Counter16BitSet(value));

    while(1)
    {
        DRV_TMR1_Tasks();
        if( (value == DRV_TMR1_Counter16BitGet()))
        {
            DRV_TMR1_Stop();
        }
    }
...
/**
  ...
  @Example 
    Refer to the example of DRV_TMR1_Counter16BitSet();
*/
