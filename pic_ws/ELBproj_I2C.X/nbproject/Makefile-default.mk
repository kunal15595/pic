...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/ELBproj_I2C.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=ELB_I2C.c ELB_OSC.c ELB_Timer.c ELB_UART.c ELBv21_HardwareConfig.c ELB_ISR.c Main.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/ELB_I2C.o ${OBJECTDIR}/ELB_OSC.o ${OBJECTDIR}/ELB_Timer.o ${OBJECTDIR}/ELB_UART.o ${OBJECTDIR}/ELBv21_HardwareConfig.o ${OBJECTDIR}/ELB_ISR.o ${OBJECTDIR}/Main.o
POSSIBLE_DEPFILES=${OBJECTDIR}/ELB_I2C.o.d ${OBJECTDIR}/ELB_OSC.o.d ${OBJECTDIR}/ELB_Timer.o.d ${OBJECTDIR}/ELB_UART.o.d ${OBJECTDIR}/ELBv21_HardwareConfig.o.d ${OBJECTDIR}/ELB_ISR.o.d ${OBJECTDIR}/Main.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/ELB_I2C.o ${OBJECTDIR}/ELB_OSC.o ${OBJECTDIR}/ELB_Timer.o ${OBJECTDIR}/ELB_UART.o ${OBJECTDIR}/ELBv21_HardwareConfig.o ${OBJECTDIR}/ELB_ISR.o ${OBJECTDIR}/Main.o

# Source Files
SOURCEFILES=ELB_I2C.c ELB_OSC.c ELB_Timer.c ELB_UART.c ELBv21_HardwareConfig.c ELB_ISR.c Main.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/ELBproj_I2C.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/ELB_UART.o: ELB_UART.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/ELB_UART.o 
	@${FIXDEPS} "${OBJECTDIR}/ELB_UART.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c ${MP_CC} $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1 -omf=elf -x c -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/ELB_UART.o.d" -o ${OBJECTDIR}/ELB_UART.o ELB_UART.c    
...
${OBJECTDIR}/ELB_ISR.o: ELB_ISR.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/ELB_ISR.o 
	@${FIXDEPS} "${OBJECTDIR}/ELB_ISR.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c ${MP_CC} $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1 -omf=elf -x c -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/ELB_ISR.o.d" -o ${OBJECTDIR}/ELB_ISR.o ELB_ISR.c    
...
${OBJECTDIR}/ELB_UART.o: ELB_UART.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/ELB_UART.o.ok ${OBJECTDIR}/ELB_UART.o.err 
	@${RM} ${OBJECTDIR}/ELB_UART.o 
	@${FIXDEPS} "${OBJECTDIR}/ELB_UART.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c ${MP_CC} $(MP_EXTRA_CC_PRE)  -g -omf=elf -x c -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/ELB_UART.o.d" -o ${OBJECTDIR}/ELB_UART.o ELB_UART.c    
...
${OBJECTDIR}/ELB_ISR.o: ELB_ISR.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/ELB_ISR.o.ok ${OBJECTDIR}/ELB_ISR.o.err 
	@${RM} ${OBJECTDIR}/ELB_ISR.o 
	@${FIXDEPS} "${OBJECTDIR}/ELB_ISR.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c ${MP_CC} $(MP_EXTRA_CC_PRE)  -g -omf=elf -x c -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/ELB_ISR.o.d" -o ${OBJECTDIR}/ELB_ISR.o ELB_ISR.c    
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/ELBproj_I2C.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -omf=elf -mcpu=$(MP_PROCESSOR_OPTION)  -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1 -o dist/${CND_CONF}/${IMAGE_TYPE}/ELBproj_I2C.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}         -Wl,--defsym=__MPLAB_BUILD=1,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map"$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=__ICD2RAM=1,--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_PK3=1
else
dist/${CND_CONF}/${IMAGE_TYPE}/ELBproj_I2C.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -omf=elf -mcpu=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/ELBproj_I2C.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}         -Wl,--defsym=__MPLAB_BUILD=1,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map"$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION)
	${MP_CC_DIR}\\pic30-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/ELBproj_I2C.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} -omf=elf
endif
