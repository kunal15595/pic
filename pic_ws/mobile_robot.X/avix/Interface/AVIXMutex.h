#ifndef __AVIXMutex_h__
#define __AVIXMutex_h__
...
//=================================================================================================
//
#define AVIX_MUTEX_UNLOCKED		((tavixMutexLocked)	0	)
#define AVIX_MUTEX_LOCKED		((tavixMutexLocked)	1	)
...
//-------------------------------------------------------------------------------------------------
tavixMutexId	
	avixMutex_Get		(	tavixKernelObjectName	pName				);


//-------------------------------------------------------------------------------------------------
tavixMutexId	
	avixMutex_Create	(	tavixKernelObjectName	pName, 
							tavixMutexLocked		fInitiallyLocked	);


//-------------------------------------------------------------------------------------------------
void 			
	avixMutex_Lock		(	tavixMutexId			id					);


//-------------------------------------------------------------------------------------------------
void 			
	avixMutex_Unlock	(	tavixMutexId			id					);
